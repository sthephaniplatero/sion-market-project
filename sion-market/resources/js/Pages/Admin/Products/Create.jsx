...
export default function CreateProduct({ sellers }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post("/admin/products", form, { forceFormData: true });
    };
    ...
    return (
        <AdminLayout>
            ...
            >
                {/* Vendedor */}
                <div>
                    <label className="block font-medium mb-1 text-gray-700">Vendedor</label>
                    <select
                        name="seller_id"
